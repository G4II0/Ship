...
using namespace std;
    ...
    public:
        ...
        void setMareA(pair<int, int> p, char (&mar_)[12][12]);
        void setMareAc(pair<int, int> p, char (&mar_)[12][12]);
        void setMareAs(pair<int, int> p, char (&mar_)[12][12]);
        void setMareAe(pair<int, int> p, char (&mar_)[12][12]);
